...
export const RecurrenceSelector: React.FC<RecurrenceSelectorProps> = ({
  ...
  const getOptionLabel = (value: string) => {
    const labels: { [key: string]: string } = {
      ...
      'fifth-sunday': 'Fifth Sunday of Month',
      'fifth-monday': 'Fifth Monday of Month',
      'fifth-tuesday': 'Fifth Tuesday of Month',
      'fifth-wednesday': 'Fifth Wednesday of Month',
      'fifth-thursday': 'Fifth Thursday of Month',
      'fifth-friday': 'Fifth Friday of Month',
      'fifth-saturday': 'Fifth Saturday of Month',
