...
import { CheckCircle, XCircle, Clock, Eye, FileText, Users, Calendar, ArrowLeft } from 'lucide-react';
...
const ManageImports = () => {
  ...
  const pendingBatches = importBatches.filter(batch => batch.status === 'pending');
  const approvedBatches = importBatches.filter(batch => batch.status === 'approved');
  const rejectedBatches = importBatches.filter(batch => batch.status === 'rejected');

  const renderBatchList = (batches: ImportBatch[]) => (
          ...
          <div className="flex items-center gap-6 text-sm text-muted-foreground">
            ...
            {batch.reviewed_at && (
              <div className="text-xs">
                Reviewed: {new Date(batch.reviewed_at).toLocaleDateString()}
              </div>
            )}
          </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Manage all event and venue imports</p>
        </div>
      </div>
          ...
          <Tabs defaultValue="pending" className="w-full">
            ...
            <TabsContent value="pending" className="mt-4">
              {pendingBatches.length === 0 ? (
                ...
                renderBatchList(pendingBatches)
              )}
            </TabsContent>
            ...
            <TabsContent value="approved" className="mt-4">
              {approvedBatches.length === 0 ? (
                ...
                renderBatchList(approvedBatches)
              )}
            </TabsContent>
            ...
            <TabsContent value="rejected" className="mt-4">
              {rejectedBatches.length === 0 ? (
                ...
                renderBatchList(rejectedBatches)
              )}
            </TabsContent>
          </Tabs>
        </CardContent>
