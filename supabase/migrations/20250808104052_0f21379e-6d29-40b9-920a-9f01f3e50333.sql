...
-- Create temp data sets for targeted users
...
-- 1) Keep DC in iwitty_profiles but ensure presence in por_eve_profiles
...
-- Note: Intentionally NOT deleting DC from iwitty_profiles to preserve FKs

-- 2) Move Kandiyams from por_eve_profiles to iwitty_profiles
-- Remove any existing iwitty row for safety
